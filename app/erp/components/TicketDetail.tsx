                ...
                <div className="form-grid">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setJobCard((p) => (p ? { ...p, jobNo: e.target.value } : p))}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      value={jobCard.item}
                      disabled={!canEditJobCard}
                      onChange={(e) => setJobCard((p) => (p ? { ...p, item: e.target.value } : p))}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      className="form-input"
                      type="date"
                      value={jobCard.inDate}
                      disabled={!canEditJobCard}
                      onChange={(e) => setJobCard((p) => (p ? { ...p, inDate: e.target.value } : p))}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      className="form-input"
                      type="date"
                      value={jobCard.outDate}
                      disabled={!canEditJobCard}
                      onChange={(e) => setJobCard((p) => (p ? { ...p, outDate: e.target.value } : p))}
                    />
                  </div>
                  <div className="form-group full">
                    <label className="form-label">Item & Site Details</label>
                    <textarea
                      className="form-textarea"
                      value={jobCard.itemAndSiteDetails}
                      disabled={!canEditJobCard}
                      onChange={(e) =>
                        setJobCard((p) => (p ? { ...p, itemAndSiteDetails: e.target.value } : p))
                      }
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      disabled={!canEditJobCard}
                      onChange={(e) =>
                        setJobCard((p) => (p ? { ...p, customerName: e.target.value } : p))
                      }
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      className="form-input"
                      value={jobCard.currentStatus}
                      disabled={!canEditJobCard}
                      onChange={(e) =>
                        setJobCard((p) => (p ? { ...p, currentStatus: e.target.value } : p))
                      }
                    />
                  </div>
                  <div className="form-group">
                  ...
                  <div className="form-group full">
                    ...
                    <textarea
                      ...
                      disabled={!canEditJobCard}
                      onChange={(e) => setJobCard((p) => (p ? { ...p, remarks: e.target.value } : p))}
                    />
                  </div>
                </div>
